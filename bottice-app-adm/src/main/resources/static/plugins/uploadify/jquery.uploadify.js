...
$.fn.Huploadify = function(opts){
	var itemTemp = '<div id="${fileID}" style="display:none" class="uploadify-queue-item"><div class="uploadify-progress"><div class="uploadify-progress-bar"></div></div><span class="up_filename">${fileName}</span><span class="uploadbtn">上传</span><span class="delfilebtn">删除</span></div>';
	var defaults = {
	...
	this.each(function(){
		...
		inputStr += '<i class="fa fa-plus"></i>' + option.buttonText;
		inputStr += '</a>';
